  ...
  <div class="wrapper">
    ...
    <nav style="background-color:RGB(40, 178, 170);" class="main-header navbar navbar-expand navbar-light navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="#" style="color: RGB(245, 245, 245);" class="nav-link">Support App </a>
        </li>
      </ul>
    ...
    <aside style="background-color:RGB(40, 178, 170);" class="main-sidebar sidebar-light elevation-4">
      ...
      <a href="#" class="brand-link">
        ...
        <span style="color: RGB(245, 245, 245); font-style: bold;" class="brand-text font-weight-dark">Support APP</span>
      </a>
